(() => {
    ...
    "node_modules/core-js/modules/es.json.stringify.js"() {
      ...
      var getPropertyList = function(replacer) {
        ...
        for (var i = 0; i < rawLength; i++) {
          ...
          else if (typeof element == "number" || classof(element) === "Number" || classof(element) === "String") key = toString3(element);
          else continue;
      ...
      var isSerializedAsObject = function(it) {
        if (!isObject2(it) || isCallable(it) || isArray2(it)) return false;
        try {
      ...
      module.exports = function(iterable, unboundFunction, options) {
        ...
        while (!(step = call(next, iterator2)).done) {
          ...
          try {
            ...
            if (iterator2) iteratorClose(iterator2, "throw", error);
            else throw error;
          }
  ...
  var require_es_suppressed_error_constructor = __commonJS({
    "node_modules/core-js/modules/es.suppressed-error.constructor.js"() {
      ...
      var $SuppressedError = function SuppressedError2(error, suppressed, message) {
        ...
        var that;
        if (setPrototypeOf) {
          that = PATCH && (!isInstance || getPrototypeOf2(this) === SuppressedErrorPrototype) ? new NativeSuppressedError() : setPrototypeOf(new $Error(), isInstance ? getPrototypeOf2(this) : SuppressedErrorPrototype);
        } else {
    ...
    "node_modules/core-js/modules/es.array.sort.js"() {
      ...
      var getSortCompare = function(comparefn) {
        return function(x, y) {
          ...
          var xString = toString3(x);
          var yString = toString3(y);
        ...
        return defineBuiltIns(create2(IteratorPrototype), {
          ...
          "return": function() {
            ...
            if (openIters) try {
              ...
              if (iterator2) return iteratorClose(iterator2, THROW, error);
              throw error;
            }
      ...
      var IteratorProxy = createIteratorProxy(function() {
        while (true) {
          ...
          if (!iterator2) {
            ...
            iterator2 = this.iterator = anObject(call(entry.method, entry.iterable));
      ...
      $({ target: "Iterator", stat: true, forced: IS_PURE }, {
        zipKeyed: function zipKeyed(iterables) {
          ...
          for (i = 0; i < allKeys.length; i++) try {
            key = allKeys[i];
            if (!call(propertyIsEnumerable2, iterables, key)) continue;
            value = iterables[key];
            if (value !== void 0) {
              push(keys, key);
  ...
  var require_es_json_raw_json = __commonJS({
    "node_modules/core-js/modules/es.json.raw-json.js"() {
      ...
      var create2 = getBuiltIn("Object", "create");
    ...
    "node_modules/core-js/internals/object-assign.js"(exports, module) {
      ...
      module.exports = !$assign || fails(function() {
        ...
        while (argumentsLength > index) {
          ...
          while (length > j) {
            key = keys[j++];
            if (!DESCRIPTORS || call(propertyIsEnumerable2, S, key)) T[key] = S[key];
          }
        }
        return T;
      } : $assign;
  ...
  var require_object_to_array = __commonJS({
    "node_modules/core-js/internals/object-to-array.js"(exports, module) {
      ...
      var IE_BUG = DESCRIPTORS && fails(function() {
        ...
        O[2] = 2;
        return !propertyIsEnumerable2(O, 2);
      });
      var createMethod = function(TO_ENTRIES) {
        return function(it) {
          ...
          while (length > i) {
            key = keys[i++];
            if (!DESCRIPTORS || (IE_WORKAROUND ? key in O : propertyIsEnumerable2(O, key))) {
  ...
  var require_es_object_proto = __commonJS({
    "node_modules/core-js/modules/es.object.proto.js"() {
      ...
      var ObjectPrototype = Object.prototype;
      var PROTO = "__proto__";
      if (DESCRIPTORS && getPrototypeOf2 && setPrototypeOf && {}[PROTO] !== ObjectPrototype) try {
  ...
  var require_async_iterator_prototype = __commonJS({
    "node_modules/core-js/internals/async-iterator-prototype.js"(exports, module) {
      ...
      if (PassedAsyncIteratorPrototype) {
        ...
        try {
          prototype2 = getPrototypeOf2(getPrototypeOf2(getPrototypeOf2(Function("return async function*(){}()")())));
          if (getPrototypeOf2(prototype2) === Object.prototype) AsyncIteratorPrototype = prototype2;
        } catch (error) {
        }
      }
    ...
    "node_modules/core-js/internals/async-from-sync-iterator.js"(exports, module) {
      ...
      AsyncFromSyncIterator.prototype = defineBuiltIns(create2(AsyncIteratorPrototype), {
        ...
        "return": function() {
          ...
          var value = hasValue ? arguments[0] : void 0;
          return new Promise2(function(resolve, reject) {
            var $return = getMethod(iterator2, "return");
            if ($return === void 0) return resolve(createIterResultObject(value, true));
            var result = anObject(hasValue ? call($return, iterator2, value) : call($return, iterator2));
            asyncFromSyncIteratorContinuation(result, resolve, reject, iterator2);
          });
        },
        "throw": function() {
          var state = getInternalState(this);
          ...
          var value = hasValue ? arguments[0] : void 0;
          return new Promise2(function(resolve, reject) {
            var $throw = getMethod(iterator2, "throw");
            if ($throw === void 0) {
              try {
                iteratorClose(iterator2, "normal");
              } catch (error) {
                return reject(error);
              }
              return reject(new TypeError("The iterator does not provide a throw method"));
            }
            var result = anObject(hasValue ? call($throw, iterator2, value) : call($throw, iterator2));
            asyncFromSyncIteratorContinuation(result, resolve, reject, iterator2, true);
          });
        }
      });
  ...
  var require_async_iterator_close = __commonJS({
    "node_modules/core-js/internals/async-iterator-close.js"(exports, module) {
      ...
      var getBuiltIn = require_get_built_in();
      var getMethod = require_get_method();
      module.exports = function(iterator2, method, argument, reject) {
        try {
          var returnMethod = getMethod(iterator2, "return");
          if (returnMethod) {
            return getBuiltIn("Promise").resolve(call(returnMethod, iterator2)).then(function(result) {
              try {
    ...
    "node_modules/core-js/internals/async-iterator-iteration.js"(exports, module) {
      ...
      var createMethod = function(TYPE) {
        ...
        return function(object, fn, target) {
          ...
          var Promise2 = getBuiltIn("Promise");
          var iterator2 = record.iterator;
          var next = record.next;
          var counter = 0;
          return new Promise2(function(resolve, reject) {
            var ifAbruptCloseAsyncIterator = function(error) {
              closeAsyncIteration(iterator2, reject, error, reject);
            };
            var loop = function() {
              try {
                try {
                ...
                Promise2.resolve(anObject(call(next, iterator2))).then(function(step) {
                  try {
                        ...
                        if (MAPPING) {
                          ...
                          var handler = function($result) {
                            if (IS_FOR_EACH) {
                              ...
                              $result ? loop() : closeAsyncIteration(iterator2, resolve, false, reject);
                            } else if (IS_TO_ARRAY) {
                              try {
                              ...
                              $result ? closeAsyncIteration(iterator2, resolve, IS_SOME || value, reject) : loop();
                            }
                          };
    ...
    "node_modules/core-js/internals/array-from-async.js"(exports, module) {
      ...
      module.exports = function fromAsync(items) {
        ...
        return new (getBuiltIn("Promise"))(function(resolve) {
          ...
          var iterator2 = usingAsyncIterator ? getAsyncIterator(items, usingAsyncIterator) : new AsyncFromSyncIterator(getIteratorDirect(getIterator(items, usingSyncIterator)));
          resolve(toArray2(iterator2, mapfn, A));
        });
      };
    }
  });
  ...
  var require_es_reflect_get = __commonJS({
    "node_modules/core-js/modules/es.reflect.get.js"() {
      ...
      var $get = function(target, propertyKey, receiver) {
        ...
        var prototype2 = getPrototypeOf2(target);
        if (isObject2(prototype2)) return $get(prototype2, propertyKey, receiver);
      };
      $({ target: "Reflect", stat: true }, {
  ...
  var require_es_reflect_set = __commonJS({
    "node_modules/core-js/modules/es.reflect.set.js"() {
      ...
      var $set = function(target, propertyKey, V, receiver) {
        ...
        if (!ownDescriptor) {
          if (isObject2(prototype2 = getPrototypeOf2(target))) {
            return $set(prototype2, propertyKey, V, receiver);
          }
    ...
    "node_modules/core-js/internals/set-is-disjoint-from.js"(exports, module) {
      ...
      module.exports = function isDisjointFrom(other) {
        ...
        return iterateSimple(iterator2, function(e) {
          if (has(O, e)) return iteratorClose(iterator2.iterator, "normal", false);
        }) !== false;
      };
    }
  });
  ...
  var require_web_url_to_json = __commonJS({
    "node_modules/core-js/modules/web.url.to-json.js"() {
      ...
      var call = require_function_call();
      var getBuiltInPrototypeMethod = require_get_built_in_prototype_method();
      var toString3 = getBuiltInPrototypeMethod("URL", "toString");
      $({ target: "URL", proto: true, enumerable: true }, {
        toJSON: function toJSON() {
          return call(toString3, this);
        }
      });
    }
  });
    ...
    "public/js/mapbox.js"() {
      displayMap = (locations, mapBoxToken) => {
        ...
        const map = new mapboxgl.Map({
          ...
          // Set the initial center of the map to the first location
          zoom: 10,
